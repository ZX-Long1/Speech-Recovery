...
from speech_command_dataset2 import StudioSet as StudioSet2 #数据集
...
def mel_spect_acc(data_loader,args,device,cuda,target_dir):
    ...
    inversion_path = '../Speech_Command/Result/blackbox_mel_spect_inversion/split_point'+str(args.split_point)+'/train_record/inversion.pth'
...
def mel_spect_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../Speech_Command/Result/blackbox_mel_spect_inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
    ...
    # mse_dir = '../mse_plot/SpeechCommand_blackbox_melspect.npy'
    ...
    mse_dir = '../snr_plot/SpeechCommand_blackbox_melspect.npy'
    np.save(mse_dir, record_mse)
...
def main():
    ...
    # for i in range(1,5):
    #     args.split_point = i
    #     mel_spect_acc_100_target_dir='../Speech_Command/Result/blackbox_mel_spect_inversion/split_point'+str(i)+'/train_record/acc_100.txt'
    #     mel_spect_acc_all_target_dir='../Speech_Command/Result/blackbox_mel_spect_inversion/split_point'+str(i)+'/train_record/acc_all.txt'
    ...
    # # 绘制mse图像
    # mel_spect_mse_100_target_dir='../Speech_Command/Result/blackbox_mel_spect_inversion/mel_spect_mse/mel_spect_mse_100_'
    # mel_spect_mse_all_target_dir='../Speech_Command/Result/blackbox_mel_spect_inversion/mel_spect_mse/mel_spect_mse_all_'
    ...
    # for i in range(1, 5):
    #     args.split_point = i
    #     mel_spect_acc_100_target_dir = '../SNR/SpeechCommand/mel_spect_blackbox_split' + str(i) + '_100.txt'
    #     mel_spect_acc_all_target_dir = '../SNR/SpeechCommand/mel_spect_blackbox_split' + str(i) + '_all.txt'
    #
