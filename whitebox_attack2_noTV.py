...
def main():
    ...
    target_dir = '../UrbanSound8K/UrbanSound8K/inversion/mfcc_no_TV/split_point' + str(args.split_point)+ '/'
    ...
    path = '../UrbanSound8K/UrbanSound8K/classifier/train_record/classifier.pth'
    str1 = 'epoch'
    str2 = 'best_cl_acc'
