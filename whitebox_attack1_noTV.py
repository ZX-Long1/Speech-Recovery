...
from Dataset1 import StudioSet       #数据集
...
parser.add_argument('--split_point', type=int, default=3, metavar='')
parser.add_argument('--cuda_id', type=int, default=1, metavar='')
parser.add_argument('--nTV', type=float, default=0, metavar='')
...
def main():
    ...
    target_dir = '../UrbanSound8K/UrbanSound8K/mel_spect_inversion/mel_spect_no_TV/split_point' + str(args.split_point)+ '/'
    ...
    path = '../UrbanSound8K/UrbanSound8K/classifier/mel_spect_train_record/classifier.pth'
    str1 = 'epoch'
    str2 = 'best_cl_acc'
    # if args.model_epoch != 0:
    #     path = path + "_" + str(args.model_epoch)
    #     str1 = 'epoch'
    #     str2 = 'acc'
    # path = path + ".pth"
    print(path)
    try:
        ...
        # print("yes")
        print("=> loaded classifier checkpoint '{}' (epoch {}, acc {:.4f})".format(path, best_epoch, best_acc))
    except:
    ...
    print("Best Inversion: epoch {}, acc {:.4f}".format(best_epoch, best_acc))
