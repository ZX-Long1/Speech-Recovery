# baseline_igd_multi_split_ci_style.py
...
# -----------------------
def main():
    parser = argparse.ArgumentParser(description='IGD baseline multi-split CI-style')
    ...
    parser.add_argument('--test_root', type=str,
                        default='../UrbanSound8K/UrbanSound8K/audio/test_set_mel_spect_numpy')
    parser.add_argument('--classifier_path', type=str,
                        default='../UrbanSound8K/UrbanSound8K/classifier/mel_spect_train_record/classifier.pth')
    parser.add_argument('--target_dir', type=str, default='../baseline/baseline_US_mel/')
    ...
    for split in split_points:
        ...
        for i, idx in enumerate(indices):
            ...
            try:
                ...
                plot_and_save_mel(mel_input.cpu(), rec_cpu, fig_path)
