...
def init1():
    ...
    train_folders_save = "..\\UrbanSound8K\\UrbanSound8K\\audio\\train_set_mel_spect_numpy"
    test_folders_save = "..\\UrbanSound8K\\UrbanSound8K\\audio\\test_set_mel_spect_numpy"
...
class StudioSet(Dataset):  # 继承Dateset 加载和预处理语音数据集
    def __init__(self, root, transform=None):
        ...
        # print(max_val) #9.5367431640625e-07
...
# # get_maxcolumn(train_set_path,n_mels,sample_rate)
# # get_maxcolumn(test_set_path,n_mels,sample_rate)
#
