# baseline_igd_speechcommand_mfcc.py
...
# SpeechCommand dataset & model (MFCC 版本)
from speech_command_dataset2 import StudioSet as StudioSetMFCC
...
def plot_and_save_mfcc(orig_tensor, rec_tensor, save_path, sr=DEFAULT_SR, hop_length=DEFAULT_HOP_LENGTH):
    ...
    plt.title('Original MFCC (SpeechCommand)')
...
# -----------------------
def main():
    parser = argparse.ArgumentParser(description='IGD baseline multi-split CI-style (SpeechCommand - MFCC)')
    ...
    parser.add_argument('--test_root', type=str,
                        default='../Speech_Command/audio/test_set_mfcc_numpy')
    parser.add_argument('--classifier_path', type=str,
                        default='../Speech_Command/Result/classifier/mfcc_train_record/classifier.pth')
    parser.add_argument('--target_dir', type=str, default='../baseline/baseline_SC_mfcc/')
