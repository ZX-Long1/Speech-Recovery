...
def main():
    ...
    target_dir_root = '../SplitLearn/UrbanSound8K/mel_spect/whitebox_inversion/split_point'
    ...
    for i in [2,3]:
        ...
        for j in [0,5,10,15,20,25,50,100]:
            ...
            path = '../SplitLearn/UrbanSound8K/mel_spect/classifier/classifier_' + str(j) + '.pth'
            str1 = 'epoch'
            str2 = 'acc'
            print(path)
            try:
