...
def train(classifier, inversion, device, data_loader, optimizer, epoch, split_point, nTV,log_interval):
    ...
    for batch_idx, (data, target) in enumerate(data_loader):
        ...
        if batch_idx % 50 == 0:
            print('Train Epoch: {} [{}/{}]\tLoss: {:.8f}'.format(epoch, batch_idx * len(data), len(data_loader.dataset), loss.item()))
...
def main():
    ...
    target_dir_root = '../SplitLearn/Speech_Command/mel_spect/whitebox_inversion/split_point'
    ...
    for i in [1,2,3,4]:
        ...
        for j in [20, 25, 50, 100]:
            ...
            for epoch in range(1, args.epochs + 1):
                train(classifier, inversion, device, train_loader, optimizer, epoch, args.split_point, args.nTV,args.log_interval)
