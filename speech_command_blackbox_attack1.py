...
parser.add_argument('--num_samples', type=int, default=50, metavar='', help='Gradient estimation samples (default: 50)')
parser.add_argument('--output_tag', type=str, default='', metavar='', help='Output directory tag')


def train(classifier, inversion, device, data_loader, optimizer, epoch, split_point, nTV, num_samples):
    classifier.eval()
    inversion.train()
    step = 0.001
...
def main():
    ...
    target_dir = f'{SC_BASE}/Result/blackbox_mel_spect_inversion{args.output_tag}/split_point{args.split_point}/'
    ...
    for epoch in range(1, args.epochs + 1):
        train(classifier, inversion, device, train_loader, optimizer, epoch, args.split_point, args.nTV, args.num_samples)
