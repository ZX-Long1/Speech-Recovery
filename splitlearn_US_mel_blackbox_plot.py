...
def mel_spect_mse_plot(data_loader, args, device, cuda, target_dir):
    ...
    for j in [0, 5, 10, 20,100]:
        ...
        for i in range(4):  # 代表四个分割点
            ...
            # 替换！！！！！！！！！！
            inversion_path = '../SplitLearn/UrbanSound8K/mel_spect/blackbox_inversion/split_point' + str(i + 1) + '/inversion_' + str(j) + '/train_record/inversion.pth'
            try:
...
def main():
    ...
    # 绘制mse图像
    mel_spect_mse_100_target_dir ='../SplitLearn/UrbanSound8K/Result/mse/mel_blackbox/'
    mel_spect_mse_plot(mel_spect_acc_100_loader,args,device,cuda,mel_spect_mse_100_target_dir)

    # # 绘制snr图像
    mel_spect_snr_100_target_dir = '../SplitLearn/UrbanSound8K/Result/snr/mel_blackbox/'
