...
def train(classifier, inversion, loader, optimizer, epoch, sp, nTV, log_interval, device, feat):
    classifier.eval()
    inversion.train()
...
def main():
    ...
    parser.add_argument('--split_point', type=int, default=1, choices=[1,2,3])
    ...
    print(f'Device: {device}  feat={args.feat}  sp={args.split_point}  nTV={args.nTV}')
    ...
    bb_dir = f'blackbox_shallow_nTV{args.nTV}'
    ...
    for epoch in range(1, args.epochs + 1):
        train(classifier, inversion, train_loader, optimizer, epoch, args.split_point, args.nTV, args.log_interval, device, args.feat)
