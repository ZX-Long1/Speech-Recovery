...
def mel_spect_SNR(data_loader,args,device,cuda,target_dir):
    ...
    inversion_path = '../UrbanSound8K/UrbanSound8K/blackbox_mel_spect_inversion/split_point' + str(args.split_point) + '/train_record/inversion.pth'
    str1 = 'best_epoch'
    str2 = 'best_acc'
    try:
...
def mfcc_SNR(data_loader,args,device,cuda,target_dir):
    print(target_dir)
    classifier = Classifier(nc=args.nc, ndf=args.ndf, nz=args.nz).to(device)
    classfier_path = '../UrbanSound8K/UrbanSound8K/classifier/train_record/classifier.pth'
    ...
    inversion_path = '../UrbanSound8K/UrbanSound8K/blackbox_mfcc_inversion/split_point' + str(args.split_point) + '/train_record/inversion.pth'
    str1 = 'best_epoch'
    str2 = 'best_acc'
    try:
        checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
...
def mel_spect_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../UrbanSound8K/UrbanSound8K/blackbox_mel_spect_inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
    ...
    # mse_dir = '../mse_plot/UrbanSound8K_blackboxbox_melspect.npy'
    ...
    mse_dir = '../snr_plot/UrbanSound8K_blackbox_melspect.npy'
    np.save(mse_dir, record_mse)
...
def mfcc_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../UrbanSound8K/UrbanSound8K/blackbox_mfcc_inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
    ...
    # # 保存mse数组
    # os.makedirs('../mse_plot/', exist_ok=True)
    # mse_dir = '../mse_plot/UrbanSound8K_blackboxbox_mfcc.npy'
    # np.save(mse_dir, record_mse)
    ...
    # #保存snr数组
    os.makedirs('../snr_plot/', exist_ok=True)
    mse_dir = '../snr_plot/UrbanSound8K_blackbox_mfcc.npy'
    np.save(mse_dir, record_mse)
    ...
    # plt.ylabel("Mean Squared Error (MSE)", fontsize=24)
    # # 设置 y 轴范围和网格
    # plt.ylim([0, 0.001])  # 设置 y 轴范围
    # plt.grid(axis="y", linestyle="--", alpha=0.7)  # 添加水平网格线
    # # 保存图像
    # plt.tight_layout()
    # plt.savefig(target_dir+'3.png', dpi=600, bbox_inches="tight")
    # plt.show()
    #
    # df = pd.DataFrame(data) #将字典data转换为pandas数据框df
    # plt.figure(figsize=(8, 6))  # 调整图像大小
    ...
    # plt.grid(axis="y", linestyle="--", alpha=0.7)  # 添加水平网格线
    # plt.tight_layout()
    # plt.savefig(target_dir+'4.png', dpi=600, bbox_inches="tight")
    # plt.show()
...
def main():
    ...
    # # # 计算准确率acc
    # # mel_spect_acc_100_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mel_spect_inversion/split_point'+str(args.split_point)+'/train_record/acc_100.txt'
    # # mel_spect_acc_all_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mel_spect_inversion/split_point'+str(args.split_point)+'/train_record/acc_all.txt'
    ...
    # # 绘制mse图像
    # mel_spect_mse_100_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mel_spect_inversion/mel_spect_mse/mel_spect_mse_100_'
    # mel_spect_mse_all_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mel_spect_inversion/mel_spect_mse/mel_spect_mse_all_'
    # mel_spect_mse_plot(mel_spect_acc_100_loader,args,device,cuda,mel_spect_mse_100_target_dir)
    # mel_spect_mse_plot(mel_spect_acc_all_loader,args, device, cuda, mel_spect_mse_all_target_dir)
    # #计算SNR
    # os.makedirs('../SNR/UrbanSound8K/', exist_ok=True)
    # for i in range(1, 5):
    #     args.split_point = i
    #     mel_spect_acc_100_target_dir = '../SNR/UrbanSound8K/mel_spect_blackbox_split' + str(i) + '_100.txt'
    #     mel_spect_acc_all_target_dir = '../SNR/UrbanSound8K/mel_spect_blackbox_split' + str(i) + '_all.txt'
    #
    ...
    #mfcc
    mfcc_acc_100_set = StudioSet2(root="../UrbanSound8K/UrbanSound8K/audio/mfccs_acc_100", transform=transform)
    mfcc_acc_all_set = StudioSet2(root="../UrbanSound8K/UrbanSound8K/audio/test_set_mfccsnumpy",transform=transform)
    ...
    # # # 计算准确率acc
    # # mfcc_acc_100_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mfcc_inversion/split_point'+str(args.split_point)+'/train_record/acc_100.txt'
    # # mfcc_acc_all_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mfcc_inversion/split_point'+str(args.split_point)+'/train_record/acc_all.txt'
    ...
    # # 绘制mse图像
    # mfcc_mse_100_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mfcc_inversion/mfcc_mse/mfcc_mse_100_'
    # mfcc_mse_all_target_dir='../UrbanSound8K/UrbanSound8K/blackbox_mfcc_inversion/mfcc_mse/mfcc_mse_all_'
    ...
    # for i in range(1, 5):
    #     args.split_point = i
    #     mel_spect_acc_100_target_dir = '../SNR/UrbanSound8K/mfcc_blackbox_split' + str(i) + '_100.txt'
    #     mel_spect_acc_all_target_dir = '../SNR/UrbanSound8K/mfcc_blackbox_split' + str(i) + '_all.txt'
    #
