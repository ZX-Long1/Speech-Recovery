...
def mel_spect_acc(data_loader,args,device,cuda,target_dir):
    ...
    inversion_path = '../SegmentLearn/mel_spect/blackbox_inversion/split_point'+str(args.split_point)+'/train_record/inversion.pth'
...
def mel_spect_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../SegmentLearn/mel_spect/blackbox_inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:'+str(args.cuda_id): cuda})
...
def main():
    ...
    for i in range(1,5):
        ...
        mel_spect_acc_100_target_dir='../SegmentLearn/mel_spect/Result/acc/blackbox/split_point'+str(args.split_point)+'_acc_100.txt'
    ...
    # 绘制mse图像
    mel_spect_mse_100_target_dir='../SegmentLearn/mel_spect/Result/mse/blackbox/mel_spect_mse_100_'
    mel_spect_mse_plot(mel_spect_acc_100_loader,args,device,cuda,mel_spect_mse_100_target_dir)

    # 绘制snr图像
    mel_spect_snr_100_target_dir='../SegmentLearn/mel_spect/Result/snr/blackbox/mel_spect_snr_100_'
