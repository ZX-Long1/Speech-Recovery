...
def mel_spect_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../Speech_Command/Result/mel_spect_inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
    ...
    # mse_dir = '../mse_plot/SpeechCommand_whiteboxbox_melspect.npy'
...
def main():
    ...
    #     mel_spect_acc_all_target_dir='../Speech_Command/Result/mel_spect_inversion/split_point'+str(i)+'/train_record/acc_all.txt'
    ...
    # mel_spect_mse_all_target_dir='../Speech_Command/Result/mel_spect_inversion/mel_spect_mse/mel_spect_mse_all_'
