...
def main():
    ...
    target_dir_root = '../SplitLearn/Speech_Command/mel_spect/blackbox_inversion/split_point'
...
#     print("================================")
#
#     target_dir = '../Speech_Command/Result/blackbox_mel_spect_inversion/split_point' + str(args.split_point)+ '/'
#     os.makedirs(target_dir, exist_ok=True)
#     os.makedirs(target_dir + 'res/', exist_ok=True)
#     os.makedirs(target_dir + 'train_record/', exist_ok=True)
#     print(target_dir)
