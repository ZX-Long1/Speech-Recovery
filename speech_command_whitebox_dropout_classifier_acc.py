...
def classifier_acc(data_loader,args,device,cuda,target_dir):
    ...
    with torch.no_grad(): #禁用梯度计算
        for data,target in data_loader:
            ...
            prediction2 = classifier(data,0,0,0,args.split_point,args.dropout)
...
def main():
    ...
    os.makedirs('../Speech_Command/Result/dropout_mel_spect_inversion/classifier_acc/', exist_ok=True)
    split=[1,3]
    ...
    for j in range(6, 10):
        for i in range(0,2):
            ...
            mel_spect_acc_100_target_dir='../Speech_Command/Result/dropout_mel_spect_inversion/classifier_acc/split' + str(args.split_point) + '_dropout'+str(args.dropout)+'_'+'acc_100.txt'
            mel_spect_acc_all_target_dir='../Speech_Command/Result/dropout_mel_spect_inversion/classifier_acc/split' + str(args.split_point) + '_dropout'+str(args.dropout)+'_'+'acc_all.txt'
