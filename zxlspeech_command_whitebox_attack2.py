...
from zxlspeech_command_Model import BasicBlock,ResNet18,Conv_sp4, Conv_sp3, Conv_sp2, Conv_sp1  # 分类器，反转模型
import numpy as np
import random
import os                    #用于文件和目录操作
...
parser.add_argument('--split_point', type=int, default=2, metavar='')
...
def main():
    ...
    target_dir = '../Speech_Command/Result/mfcc_inversion/split_point' + str(args.split_point)+ '/'
