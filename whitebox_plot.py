...
def mfcc_SNR(data_loader,args,device,cuda,target_dir):
    ...
    inversion_path = '../UrbanSound8K/UrbanSound8K/inversion/split_point' + str(args.split_point) + '/train_record/inversion.pth'
    str1 = 'best_epoch'
    str2 = 'best_acc'
    try:
        checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
...
def mel_spect_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../UrbanSound8K/UrbanSound8K/mel_spect_inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
...
def mfcc_mse_plot(data_loader,args,device,cuda,target_dir):
    ...
    for i in range(4): #代表四个分割点
        ...
        inversion_path = '../UrbanSound8K/UrbanSound8K/inversion/split_point' + str(i+1) + '/train_record/inversion.pth'
        str1 = 'best_epoch'
        str2 = 'best_acc'
        try:
            checkpoint = torch.load(inversion_path, map_location={'cuda:1': cuda})
    ...
    # #保存mse数组
    # os.makedirs('../mse_plot/', exist_ok=True)
    # mse_dir = '../mse_plot/UrbanSound8K_whitebox_mfcc.npy'
    # np.save(mse_dir, record_mse)
    ...
    # #保存snr数组
    os.makedirs('../snr_plot/', exist_ok=True)
    mse_dir = '../snr_plot/UrbanSound8K_whitebox_mfcc.npy'
    np.save(mse_dir, record_mse)
...
def main():
    ...
    # ## 计算准确率acc
    # # mel_spect_acc_100_target_dir='../UrbanSound8K/UrbanSound8K/mel_spect_inversion/split_point'+str(args.split_point)+'/train_record/acc_100.txt'
    # # mel_spect_acc_all_target_dir='../UrbanSound8K/UrbanSound8K/mel_spect_inversion/split_point'+str(args.split_point)+'/train_record/acc_all.txt'
    ...
    # # # 绘制mse图像
    # # mel_spect_mse_100_target_dir='../UrbanSound8K/UrbanSound8K/mel_spect_inversion/mel_spect_mse/mel_spect_mse_100_'
    # # mel_spect_mse_all_target_dir='../UrbanSound8K/UrbanSound8K/mel_spect_inversion/mel_spect_mse/mel_spect_mse_all_'
    ...
    ## 计算准确率acc
    # mfcc_acc_100_target_dir='../UrbanSound8K/UrbanSound8K/inversion/split_point'+str(args.split_point)+'/train_record/acc_100.txt'
    # mfcc_acc_all_target_dir='../UrbanSound8K/UrbanSound8K/inversion/split_point'+str(args.split_point)+'/train_record/acc_all.txt'
    ...
    # # 绘制mse图像
    # mfcc_mse_100_target_dir='../UrbanSound8K/UrbanSound8K/inversion/mfcc_mse/mfcc_mse_100_'
    # mfcc_mse_all_target_dir='../UrbanSound8K/UrbanSound8K/inversion/mfcc_mse/mfcc_mse_all_'
    ...
    # for i in range(1, 5):
    #     args.split_point = i
    #     mel_spect_acc_100_target_dir = '../SNR/UrbanSound8K/mfcc_whitebox_split' + str(i) + '_100.txt'
    #     mel_spect_acc_all_target_dir = '../SNR/UrbanSound8K/mfcc_whitebox_split' + str(i) + '_all.txt'
    #
